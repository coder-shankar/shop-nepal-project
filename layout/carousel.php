  ...
  <div class="carousel slide" id="myCarousel">
    ...
    <div class="carousel-inner">
      ...
      <!--end of item-->
           ...
           <div class="item" id="slide3"> <img src="images/slide3.jpg" alt="">
        <div class="carousel-caption">
          <h4>Mac Laptop</h4>
          <p>Mac laptop are best performanance Laptop </p>
        </div>
        <!-- end of carousel-caption-->
      ...
      <!--end of item-->
            ...
            <div class="item" id="slide4"> <img src="images/slide4.jpg" alt="">
        <div class="carousel-caption">
          <h4>Dell Laptop</h4>
          <p>Dell Inspiron 3421 is the best choice for new generation </p>
        </div>
